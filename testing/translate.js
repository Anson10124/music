window.addEventListener('load', () => {
    ...
    function displayLyrics(lyrics) {
        ...
        lyrics.forEach((line, index) => {
            if (line.text.trim() === '') {
                ...
                if (isTranslation) {
                    currentLine.classList.add('line-translated');
                }
                ...
                // Check if the line is a translation by detecting Chinese characters
    ...
    const toggleTranslation = document.getElementById('translation');

    toggleTranslation.addEventListener('click', () => {
        const translatedLines = document.querySelectorAll('.line-translated');
